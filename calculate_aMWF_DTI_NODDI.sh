...
then
    ...
    fslmaths lesions_in_MWF_bin.nii.gz -binv -mul WM_mask_in_MWF_bin.nii.gz NAWM_in_MWF_bin.nii.gz

    cd ../DWI

    fslmaths lesions_in_b0_bin.nii.gz -binv -mul WM_mask_in_DWI_bin.nii.gz NAWM_in_DWI_bin.nii.gz
...
fslmaths NAWM_in_DWI_bin.nii.gz -mas mask.nii NAWM_in_DWI_masked.nii.gz
...
fslmaths NAWM_in_MWF_bin.nii.gz -mas MWF_ref_bet_mask.nii.gz NAWM_in_MWF_masked.nii.gz
